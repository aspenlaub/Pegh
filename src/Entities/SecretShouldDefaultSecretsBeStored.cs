...
namespace Aspenlaub.Net.GitHub.CSharp.Pegh.Entities {
    public class SecretShouldDefaultSecretsBeStored : ISecret<ShouldDefaultSecretsBeStored> {
        ...
        public ShouldDefaultSecretsBeStored DefaultValue => vDefaultValue ?? (vDefaultValue = new ShouldDefaultSecretsBeStored { AutomaticallySaveDefaultSecretIfAbsent = true });
