...
public class WaitTest {
    ...
    public void CanWait() {
        ...
        Assert.IsLessThan(100, elapsedMilliseconds, $"Expected less than 100 milliseconds elapsed time, it were {elapsedMilliseconds} milliseconds");
        ...
        Assert.IsLessThan(600, elapsedMilliseconds, $"Expected less than 600 milliseconds elapsed time, it were {elapsedMilliseconds} milliseconds");
        ...
        Assert.IsLessThan(1500, elapsedMilliseconds, $"Expected less than 1500 milliseconds elapsed time, it were {elapsedMilliseconds} milliseconds");
    }
