...
public class SecretCrewMember : ISecret<CrewMember> {
    ...
    private static CrewMember _defaultCrewMember;
    public CrewMember DefaultValue => _defaultCrewMember ??= new CrewMember { FirstName = DefaultFirstName, SurName = "O'Brien", Rank = "Chief Petty Officer" };
